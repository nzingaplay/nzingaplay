        ...
        {showLogin && (
          <div className="bg-yellow-900 p-6 rounded max-w-md mx-auto mb-6">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              <input type="text" placeholder="Email ou telefone" className="p-2 rounded text-black" required />
              <input type="password" placeholder="Senha" className="p-2 rounded text-black" required />
              <button type="submit" className="bg-yellow-400 text-black px-4 py-2 rounded hover:bg-yellow-300">Entrar</button>
            </form>
          </div>
        )}
